...
public static class Root
{
    ...
    private static Config _rootConfig;
    public static Config Config => _rootConfig ?? (_rootConfig = Configs.ContainsKey("*-0-root") ? Json.Decode<Config>(Configs["*-0-root"].JsonContent) : new Config());
