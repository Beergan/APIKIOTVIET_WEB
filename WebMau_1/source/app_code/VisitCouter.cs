...
public static class VisitCounter
{
	...
	public static void OnRequestBegin()
	{
		...
		{
			var ipAddress = request.ServerVariables["HTTP_CF_CONNECTING_IP"] ?? request.ServerVariables["REMOTE_ADDR"];
	...
	public static void OnRequestBegin_New()
	{
		...
		else
		{
			...
			visitData.Ip = request.ServerVariables["HTTP_CF_CONNECTING_IP"] ?? request.ServerVariables["REMOTE_ADDR"];
